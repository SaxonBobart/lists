...
- `Core/Storage/AttachmentStore.swift` owns root-confined attachment paths,
  ...
  and paired PaperKit drawing source/portable-preview storage. Legacy PencilKit
  sources are upgraded at the document boundary without flattening their ink.
