...
struct EditorHelpView: View {
    ...
    private let sections: [(String, String)] = [
        ...
        ("Links and navigation", "The link button offers Internal Link or External Link. Internal Link opens the item browser, then Whole Document or a heading, including headings in this document. Both flows return to your original selection. While editing, tap a link to edit its Markdown; dismiss the keyboard to follow links by tapping. Touch and hold for text selection and Open. Heading links use ordinary Markdown anchors; renaming a heading changes its anchor. Document Navigator contains headings, links, backlinks, and Find. Web links never fetch previews."),
        ("Attachments", "The paperclip adds photos, videos, scans, files, or an audio recording. Photos and standalone PDFs start expanded; other file links start as compact cards. While editing, tap either side of an attachment to place the cursor beside it. Backspace removes the entire reference and Undo restores it. Dismiss the keyboard to open attachments by tapping. Touch and hold for Open and Hide Preview / Show Preview. Preview preferences stay on this device and never change your Markdown. Raw Markdown exposes attachment source. Removing a reference never deletes the file. Keep the whole exported library together so links continue to work."),
        ("Equations and diagrams", "Use $x^2$ for inline math, $$ on separate lines for a display equation, and a fenced mermaid block for diagrams. While editing, tap a result to select its content without delimiters. Its live preview appears underneath; syntax errors appear there too. Moving away hides successful source. A cursor just after the last closing delimiter appears beside the preview. Rendering works offline."),
        ("Code", "Type a language after the opening three backticks for syntax highlighting. The popup matches language names and aliases; tap a suggestion or use arrows and Return to choose it. Only that identifier changes. Unknown languages remain plain text. Code stays directly editable and works offline. Footnote is in the scrollable style row in Aa."),
