...
struct EditorHelpView: View {
    ...
    private let sections: [(String, String)] = [
        ...
        ("Attachments", "The paperclip adds photos, videos, scans, files, or an audio recording. Tap media to open or play it. Its menu offers sharing, descriptions, replacement, and removal. Removing a reference does not immediately delete the file. Keep the whole exported library together so links continue to work."),
